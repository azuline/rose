...
impl PathTemplateConfig {
    pub fn with_defaults(default: PathTemplateTriad) -> Self {
        PathTemplateConfig {
            source: default.clone(),
            releases: default.clone(),
            releases_new: default.clone(),
            releases_added_on: default.clone(),
            releases_released_on: default.clone(),
            artists: default.clone(),
            genres: default.clone(),
            descriptors: default.clone(),
            labels: default.clone(),
            loose_tracks: default.clone(),
            collages: default.clone(),
            playlists: PathTemplate::new("{{ title }}".to_string()),
        }
    }
...
pub static DEFAULT_TEMPLATE_PAIR: Lazy<PathTemplateTriad> = Lazy::new(|| PathTemplateTriad {
    release: PathTemplate::new("{{ title }}".to_string()),
    track: PathTemplate::new("{{ title }}".to_string()),
    all_tracks: PathTemplate::new("{{ title }}".to_string()),
});
