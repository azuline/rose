...
INSERT INTO releases
       (id  , source_path    , cover_image_path , added_at                   , datafile_mtime, virtual_dirname, title      , releasetype, year, multidisc, new  , formatted_artists)
...
INSERT INTO tracks
       (id  , source_path      , source_mtime, virtual_filename, formatted_release_position, title    , release_id, tracknumber, discnumber, duration_seconds, formatted_artists)
